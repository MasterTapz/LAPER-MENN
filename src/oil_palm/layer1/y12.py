...
try:
    from oil_palm.config import DATA_CLEAN_DIR as _DATA_CLEAN
except ImportError:
    _DATA_CLEAN = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(BASE))), "data_clean")
...
def label_audit():
    ...
    p = os.path.join(_DATA_CLEAN, "layer1_crowns.csv")
