...
try:
    from oil_palm.config import DATA_CLEAN_DIR as DATA
except ImportError:
    # Fallback for the rare case this file is run standalone without the
    # package installed (`pip install -e .`) — mirrors config.py's own default.
    DATA = os.path.abspath(os.path.join(BASE, os.pardir, os.pardir, os.pardir, "data_clean"))
